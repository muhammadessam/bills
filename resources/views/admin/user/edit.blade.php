            ...
            <div class="widget-content widget-content-area">
                <form action="{{route('admin.user.update', $user)}}" method="post">
                    ...
                    <div class="form-row">
                        <div class="n-chk">
                            <label class="new-control new-checkbox checkbox-primary">
                                <input name="is_sms" type="checkbox" value="1" {{old('is_sms', $user->is_sms)==1 ? 'checked' : ''}} class="new-control-input">
                    ...
                    <div class="form-row">
                        <div class="n-chk">
                            <label class="new-control new-checkbox checkbox-primary">
                                <input name="is_email" type="checkbox" value="1" {{old('is_sms', $user->is_email)==1 ? 'checked' : ''}} class="new-control-input">
                    ...
                    <div class="form-row">
                        <div class="n-chk">
                            <label class="new-control new-checkbox checkbox-primary">
                                <input name="is_whatsapp" type="checkbox" value="1" {{old('is_sms', $user->is_whatsapp)==1 ? 'checked' : ''}} class="new-control-input">
